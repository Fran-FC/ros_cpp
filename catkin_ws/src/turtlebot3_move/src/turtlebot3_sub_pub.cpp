...
geometry_msgs::Point **result_points;
...
void doneCB(const actionlib::SimpleClientGoalState &state,
  ...
  ROS_INFO("Printing result points");
  for (const geometry_msgs::Point &point : result->list_of_odoms) {
...
void activeCB() { ROS_INFO("Action went active"); }
/*************************************/
